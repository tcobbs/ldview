...
set VS18=/p:PlatformToolset=v145 /p:WindowsTargetPlatformVersion=10.0
...
if exist "C:\Program Files (x86)\Microsoft Visual Studio\18\BuildTools\VC\Auxiliary\Build\vcvars64.bat" set VS=%VS18%
...
msbuild %CONFIG% %VS% Translations\Czech\Czech.vcxproj         /p:Platform=x64 /m
msbuild %CONFIG% %VS% LDViewThumbs\LDViewThumbs.vcxproj /p:SolutionDir=%CD%\ /p:Platform=win32 /m
msbuild %CONFIG% %VS% LDViewThumbs\LDViewThumbs.vcxproj /p:SolutionDir=%CD%\ /p:Platform=x64 /m

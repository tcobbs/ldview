...
MAKEOPT += \"TESTING=-I$$[QT_INSTALL_HEADERS] $$QMAKE_CXXFLAGS_STATIC_LIB $(TESTING) -DUSE_CPP11 -std=c++11\"

DEFINES 	+= EXPORT_3DS USE_CPP11
DEFINES 	+= _NO_BOOST

QMAKE_CXXFLAGS       += $(Q_CXXFLAGS) -std=c++11
